...
export default function AboutPage() {
  const features = [
    { 
      ...
      desc: "Durable, comfortable, and high-performance bicycles built to last." 
    },
    { 
      title: "Wide Range", 
      desc: "Mountain bikes, road bikes, electric cycles, and kids’ cycles." 
    },
    { 
      title: "Expert Guidance", 
      desc: "Our knowledgeable team helps you find the perfect ride." 
    },
    { 
      title: "Customer First", 
      desc: "Fast delivery, easy returns, and friendly support." 
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-10">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Ride into Adventure with <span className="text-blue-600">RideSphere</span> 
          ...
          <div className="relative w-full mt-10 md:mt-0">
            <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100 h-[400px] md:h-[600px] bg-white group">
              <img 
                src="https://switchback.alpsinsight.com/wp-content/uploads/2023/02/221219-Deep-Winter-3-09401.jpg" 
                alt="Cycling adventure in the mountains" 
